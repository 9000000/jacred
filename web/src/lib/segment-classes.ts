/** Shared iOS-style segmented control classes (Familiarity across Search/Stats/Settings). */

/** Track: soft secondary fill, continuous radius. */
...
/** Full-width track that wraps (settings category tabs). */
...
/** Sort strip on phone: equal chips, no horizontal scroll. */
...
/** Compact chrome segment (locale, etc.). */
...
/** Toolbar segment at chrome height (stats view, form/raw). */
...
/** Selected thumb shadow — matches Apple segmented control lift. */
const segmentOn =
...
/** Sort chips: equal width on phone, intrinsic on lg. */
